...
`NOTE: This example provided for demo purpose only. x11 is not supported by https://source.codeaurora.org/external/imx/meta-fsl-bsp-release/tree/imx/README?h=rocko-4.9.88-2.0.0_ga#n84[NXP] for imx8.`
